...
{
    //计算数据文件大小，从而确定bmp图片的大小、高度，宽默认320px
$data_file_size = filesize($data_file_name);
$bi_data_size = floor($data_file_size*3/2);
//位图数据大小一定要是4的倍数
while($bi_data_size%4 !== 0)
{
    $bi_data_size -= 1;
}
$bi_width = 320;
$bi_height = floor($bi_data_size / ($bi_width*3));
