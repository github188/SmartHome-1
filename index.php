	...
	<div class="row-fluid">
		<div class="span4">
			...
			<p>
                ...
                <button class="btn" type="button" onClick="sendCommand('A1')">前进</button> 
                <button class="btn" type="button" onClick="sendCommand('A2')">后退</button> 
                <button class="btn" type="button" onClick="sendCommand('A3')">停止</button>
            <br/> 
            <br/> 
			<p>
				<span class="label">方向：</span>
			</p> 
                <button class="btn btn-primary" type="button" onClick="sendCommand('B1')">左转</button> 
                <button class="btn btn-primary" type="button" onClick="sendCommand('B2')">右转</button> 
                <button class="btn btn-primary" type="button" onClick="sendCommand('B3')">正前</button>
            <br/> 
            <br/> 
			<p>
